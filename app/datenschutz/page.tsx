        ...
        <div className="container-lsc py-16 md:py-20">
          <Prose>
            ...
            <p>
              ...
              Infrastruktur „Cloudflare Workers“ gehostet. Beim Aufruf der
              Website werden technisch notwendige Daten (z. B. IP-Adresse,
              Zeitpunkt des Zugriffs, aufgerufene Seite) verarbeitet, um die
              Auslieferung der Website und die Sicherheit zu gewährleisten.
            ...
            <p>
              Bei jedem Zugriff werden automatisch Informationen erhoben, die
              Ihr Browser übermittelt (u. a. Browsertyp/-version,
              Betriebssystem, Referrer-URL, Uhrzeit, IP-Adresse in
              gekürzter/anonymisierter Form). Diese Daten werden nicht mit
              anderen Datenquellen zusammengeführt und dienen ausschließlich der
            ...
            <p>
              ...
              Street, Dublin 4, Irland). Die Karte wird{" "}
              <strong>nicht automatisch geladen</strong>: Sie sehen zunächst nur
              einen Hinweis mit einer Schaltfläche. Erst wenn Sie diese
              anklicken, wird die Karte nachgeladen. Bis dahin geht keinerlei
              Anfrage an Google. Beim Laden werden Daten – u. a. Ihre IP-Adresse
              – an Google übermittelt und es können Cookies gesetzt werden; eine
              Übermittlung in die USA ist dabei nicht ausgeschlossen.
              Rechtsgrundlage ist Ihre Einwilligung nach Art. 6 Abs. 1 lit. a
              DSGVO. Ihre Entscheidung merken wir uns nur für die Dauer Ihres
              Besuchs (Session Storage); nach dem Schließen des Browser-Tabs
              werden Sie erneut gefragt. Weitere Informationen finden Sie in der{" "}
              <a
            ...
            <p>
              Auf der Seite „360° Rundgang" binden wir eine interaktive
              Panorama-Tour unseres Dienstleisters (vr-easy) ein. Auch sie wird
              nicht automatisch geladen, sondern erst, wenn Sie die
              entsprechende Schaltfläche anklicken; bis dahin geht keine Anfrage
              an den Anbieter. Beim Laden können dabei technische Daten (u. a.
              IP-Adresse) an den Anbieter übermittelt werden. Rechtsgrundlage
            ...
            <p>
              ...
              Nutzung setzen wir „Cloudflare Turnstile" (Cloudflare, Inc.) ein.
              Dabei werden technische Informationen (u. a. IP-Adresse,
              Browser-Merkmale) an Cloudflare übermittelt und verarbeitet, um
              menschliche von automatisierten Anfragen zu unterscheiden.
              Turnstile setzt nach Angaben des Anbieters keine Cookies zu
              Werbezwecken. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO
              (berechtigtes Interesse an Spam-/Missbrauchsschutz).
            </p>

            <h2>9. Cookies &amp; Tracking</h2>
            <p>
              Diese Website setzt keine Tracking- oder Marketing-Cookies und
              bindet keine Analyse-Dienste ein. Es werden ausschließlich
            ...
            <p className="mt-10 text-sm italic">
              Hinweis: Diese Datenschutzerklärung ist eine an das Projekt
              angepasste Vorlage. Bitte prüfen und ergänzen Sie sie vor
              Veröffentlichung (z. B. konkrete
              Hosting-/Auftragsverarbeitungs-Angaben) und lassen Sie sie
              rechtlich abnehmen.
            </p>
          </Prose>
        </div>
